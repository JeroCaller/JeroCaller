...
### 지속적인 배움으로 사소한 불편함을 서비스로 만들어나가는 개발자, JeroCaller입니다.
...
<table align="center">
  ...
  <tr>
    <td align="center" colspan="2">한 줄 소개</td>
    <td align="center">인원</td>
    <td align="center">역할 및 한 일</td>
  </tr>
  <tr>
    <td align="center" colspan="2">Spring Boot 기반 웹 애플리케이션 제작에서 사용할 간단한 유틸 라이브러리</td>
    <td align="center">개인</td>
    <td align="center">BE, 배포, CI/CD</td>
  </tr>
  <tr>
    <td align="center" colspan="4">설명</td>
  </tr>
  <tr>
    <td colspan="4">
      <ul>
        <li>Spring Boot로 공부 또는 프로젝트 진행 시 일부 기능들이 자주 중복되어 나타날 때마다 사용하던 복사/붙여넣기 방식의 불편함을 해소하기 위해 라이브러리화.</li>
        <li>Jitpack을 이용하여 온라인에 배포함으로써 언제 어디서든 누구나 해당 라이브러리 사용 가능.</li>
        <li>JWT 인증에 필요한 Filter 및 Provider 제공, Cookie 추가 및 삭제 등의 기능 포함. </li>
        <li>사용 편리성을 위한 Javadoc 문서 배포. </li>
        <li>안정적인 사용을 위한 테스트 코드 작성 : code coverage 92% 달성. </li>
        <li>프로젝트에 적용 시 최대 478줄의 코드 줄 수 절감 기대 효과. </li>
      </ul>
    </td>
  </tr>
  ...
  <tr>
    <td align="center" colspan="2">음식점 리뷰 및 추천 웹 애플리케이션</td>
  ...
  <tr>
    <td colspan="4">
      <ul>
        <li>기존 음식점 추천 사이트에서는 사용자 맞춤형 음식점 추천 기능 및 댓글, 별점, 오픈 채팅 등을 이용한 사용자간 커뮤니티 활성화 기능에 부족함을 느껴 제작. </li>
        <li>사용자의 현재 위치 중심의 음식점 목록 조회, 사용자가 즐겨찾기한 음식점들을 토대로 새로운 음식점 추천 기능. </li>
      </ul>
    </td>
  </tr>
  <tr><td colspan="4"><br/></td></tr>
  ...
  <tr>
    <td align="center" colspan="2">계산기, todo list 등 여려 도구들을 만들어 모아놓은 웹 애플리케이션.</td>
    <td align="center">개인</td>
  ...
  <tr>
    <td colspan="4">
      <ul>
        <li>계산기 사이트, todo list 사이트 등 각자의 사이트들은 있지만 이들을 하나로 모아놓은 사이트를 찾기 어려워 매번 여러 사이트들을 이곳저곳 돌아다녀야하는 불편함에 만든 웹 앱.</li>
        <li>계산기, 나이 계산기, 달력, todo list, 시계, 날짜 계산기 기능들을 만들어 하나의 웹 앱으로 통합 및 배포.  </li>
      </ul>
    </td>
  </tr>
</table>
